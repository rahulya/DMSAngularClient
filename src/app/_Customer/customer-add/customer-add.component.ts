 ...
 CustomerSave() {
    ...
    if (this.actionType === 'Add') {
      ...
      let customer: customer = { 
        ...
        companyId:this.companyDatabaseSelected.companyDatabaseId,
        userId:this.companyDatabaseSelected.userId,
        databaseName:this.companyDatabaseSelected.companyDatabaseCode ,
        isFileSave:false    
      };
      debugger
      this._http.saveCustomerData(customer).subscribe((data) => { 
        debugger        
       this.showToast();
       this.onReset()      
     });
